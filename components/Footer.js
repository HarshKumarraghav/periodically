      ...
      <h2 className="font-head bg-primary-color text-primary-white text-md w-28 text-center border-2 p-2 rounded-xl shadow-light-card">
        ...
        <div className="flex text-xs flex-col text-primary-white">
          ...
          <h2 className="text-sm">
            ...
            , Skilled at Algorithms, C (Programming Language), C++, and Video Editing.
            Strong media and communication professional with a Bachelor's degree
            focused in Information Technology from Gautam buddha University.
          </h2>
        </div>
      </div>
